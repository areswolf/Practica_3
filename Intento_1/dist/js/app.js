...
},{"./articles-list.js":3,"./form.js":4,"./init.js":5,"./jquery.simplePagination":6,"./like-button.js":7,"./pagination.js":8}],3:[function(require,module,exports){
var $ = require('jquery');
/*
console.log("Songs list");


$("#idlike9").click(function () {
    //alert("HECHO");
    if ($(this).css("color")=="black") {
        $(this).css("color","#fca600");
    }
    else {
        $(this).css("color","#333");
    }
